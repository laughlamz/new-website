...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/control_device.css"/>
  <link rel="stylesheet" type="text/css" href="css/responsive_control.css"/>
</head>
<body> 
  <div id="contentD1">
...
<script type="text/javascript">
  $("#btnDevice1").click(function() {                 //Update new act device 1
      if(this.checked) {
        ...
        $.ajax({
          url: 'blocks/update_device1_to1.php',
          type: 'post'
        });
      }
      else{
        ...
        $.ajax({
          url: 'blocks/update_device1_to0.php',
          type: 'post'
        });
      }
  });
  ...
  $("#btnDevice2").click(function() {                 //Update new act device 2
      if(this.checked) {
        console.log("current 0 -click- return 1");
        $.ajax({
          url: 'blocks/update_device2_to1.php',
          type: 'post'
        });
      }
      else{
        console.log("current 1 -click- return 0");
        $.ajax({
          url: 'blocks/update_device2_to0.php',
          type: 'post'
        });
      }
  });
  ...
  $("#btnDevice3").click(function() {                 //Update new act device 3
      if(this.checked) {
        console.log("current 0 -click- return 1");
        $.ajax({
          url: 'blocks/update_device3_to1.php',
          type: 'post'
        });
      }
      else{
        console.log("current 1 -click- return 0");
        $.ajax({
          url: 'blocks/update_device3_to0.php',
          type: 'post'
        });
      }
  });
